...
return [
    ...
    */
    ...
    // 'name' => 'Asia Expeditions - Destination Management Company (Myanmar & Indochina)',
    'name' => 'Asia Expeditions',

    'title' => 'Admin Dashboard',
    'logo' => 'asia-expeditions.png',

    'icon' => 'AE-Logo.ico',

    'email' => env('MAIL_USERNAME', 'debug'),
    // 'email' => 'inquiry@asia-expeditions.com',
    /*
    |--------------------------------------------------------------------------
    ...
    |
    */
    'payment' => ' <div style="text-align: left; padding: 21px;">
