        ...
        success: function(dataFile){
            if (dataFile.status == 1) {
                ...
                $.each(dataFile.files, function(key,val){
                    data +="<li data-type='"+datatype+"' data-label='"+val.picture+"' data-url='/storage/thumbnail/"+val.picture+"' class='col-sm-3 col-xs-4 attachment' style='padding:10px;height:136px;'> <i style='display:none;' class='fa fa-check'></i><img src='/storage/thumbnail/"+val.picture+"' style='width:100%; height:100%;'></li>";
                });
