...
<table width="100%" border="0" cellspacing="0" cellpadding="0" >
  <tbody><tr>
    <td valign="top">
        <p>Asia Expeditions Co., Ltd<br>
Destination Management Company <br>
Cambodia: SH-01, Galaxy Residence, National Road No. 6A,<br>
Khan Chhroy Changvar District , 12110 Phnom Penh,<br>
Tel: +855 (23) 432007, HP: +855 (12) 897698 / +855 (12) 732236<br>
E-mail: inquiry@asia-expeditions.com</p>
<p>&nbsp;</p>
<p>&nbsp;</p>    </td>
    <td>&nbsp;</td>
    <td valign="top" align="right">
    <img src="https://tourwriter.asia-expeditions.com/userfiles/image/contents/asia_expeditions.jpg" height="130" title="Asia Expeditions"></td>
  </tr>
</tbody></table>

	<center>
        <h1>Payment online with Asia-expeditions.com </h1>
    </center>
</table>

    <table class="table" width="85%" align='center' cellpadding='5' border='0'>
      
        <tr class='title'>
            <td colspan="2" height="25">
                <p><strong> Invoice: #<?php echo $receiptNo; ?></strong></p>
            </td>
        </tr>
        <tr>
