...
@section('content')
	...
	<div class="container" >
		...
		<div class="col-md-12">
			<?php
				$get_province = \App\Tour::getTourByprovince($countryId);
											  
			?>
		
			<div class="title text-center"><h2>
				<b>Popular Places in</b><b style="text-transform: capitalize;"> {{$coun['country_name']}}</b></h2>
			</div>				
	            <div class="row">   
	            	<div class="col-md-12">	  
		...
		<div class="col-md-12">
			<?php
	        	$tourLink = \App\Tour::where(['country_id'=> $countryId, 'web'=> 1, 'post_type'=> 0,'tour_status'=>1])->orderBy('tour_name', 'ASC')->get();
	        ?>
	        @if($tourLink->count() > 0)
