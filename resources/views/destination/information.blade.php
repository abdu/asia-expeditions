		        	...
		        	<div class="tab-content">
				        ...
				        ?>
				            ...
				            <div class="col-md-4 col-ms-4 col-lg-4  col-xs-6 " style="margin-top:25px;">
				                ...
				                <a target="_blank" href="{{route('teamDetail', $team['name'])}}">

				                    <img style="width: 41%; height:140px;"  src="https://system.asia-expeditions.com/storage/avata/thumbnail/{{$team->picture}}" class="img-quadrata center-block w3-circle" >
				                </a>
				                <a target="_blank" href="{{route('teamDetail', $team['name'])}}">
				                  <h3 class="text-center">{{ $team['fullname'] }}<br/><small> {{$position}}</small></h3>
				              	</a>
				            </div>               
