...
<div id="wrapper">
    ...
    <div id="page-wrapper" style="padding: 0 15px;">
    	...
    	<div class="row">    		
	    	<form method="POST" action="{{route('ourNewsCreate')}}" enctype="multipart/form-data">
		    	{{ csrf_field() }}
						    ...
						    <div class="box-body">
						      	<div class="col-md-12 col-md-12">
			                    	<div class="form-group">
			                            <input type="text" name="title" class="form-control input-md" placeholder="Title" value="{{{$tour->tour_name or ''}}}" required>
			                        </div>		            
									...
									<script src="{{asset('backend/lib/tinymce.min.js')}}"></script>
			                      	<div class="form-group row">
		                            	<div class="col-md-12">
											...
											<textarea name="tour_desc" class="form-control my-editor" placeholder="Say Something">{!! $tour->tour_desc or '' !!}</textarea>
							            </div>
			                        </div>			                    
			                        <hr class="colorgraph">
				                </div>        
	                ...
	                <div class="panel panel-default">
	                  <div class="panel-body">
	                    <div id="wrap-feature-image" style="position:relative;">
	                      ...
	                      <input type="hidden" name="image" id="data-img" value="{{{$tour->tour_photo or ''}}}">
	                      @if(isset($tour->tour_photo) && !empty($tour->tour_photo))
	                      <img id="feature-img" src="{{isset($tour->tour_photo) ? Shared::getInstance()->urlResource($tour->tour_photo, $tour->user_id) : '#' }}" style="width:100%;margin-bottom:12px;" class="btnUploadFiles" data-type="single-img" data-toggle="modal" data-target="#myUpload">
	                      @else
	                      	<img id="feature-img" src="{{isset($tour->tour_photo) ? Shared::getInstance()->urlResource($tour->tour_photo, $tour->user_id) : '#' }}" style="width:100%;display:none;margin-bottom:12px;" class="btnUploadFiles" data-type="single-img" data-toggle="modal" data-target="#myUpload">
