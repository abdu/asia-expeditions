				...
				<table class="table">
					<thead>
						<tr style="color: #31708f; background-color: #d9edf7;border-color: #bce8f1;">
							...
							<th style="border-bottom: none;">Pax Number</th>
						</tr>
					</thead>
				</table>
				<?php
				...
				<table class="table">
					...
					@foreach($tours_cart as $tour)	
						<tr>
							...
							<td><a href="{{route('tourDetails', $tour['item']['slug'])}}">{{$tour['item']['tour_name']}}</a></td>
			...
			<div class="panel panel-info">
				...
				<div class="panel-body">
					...
					<div class="row">
						<div class="col-md-12">
							@if(Auth::check())
								<a class="btn btn-danger btn-block" href="/payment">PROCESS PAYMENT</a>
							@else
	...
	@else
		...
		<div class="col-md-12">
			<div class="alert alert-success"> YOUR CART IS EMPTY...! 
				<strong ><a class="btn btn-link" href="{{url()}}">COMTINOUSE SHOPPING CART</a></strong>
			</div>
		</div>
	@endif	
</div>
