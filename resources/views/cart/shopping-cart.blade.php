...
<?php use App\components\Shared; use App\Cart; ?>
@section('content')
	...
	<div class="container"><br><br>
		...
		<div class="row">
			<div class="col-md-12">
				<div class="col-md-9">
					<h3>({{Cart::totalCartQty()}}) {!! Cart::totalCartQty() > 1 ? "Items" : "Item" !!} In Shopping Cart</h3>
					<span class="pull-right btn text-danger">Remove All {!! Cart::totalCartQty() > 1 ? "Items" : "Item" !!}</span>
				</div>
							...
							<table class="table">
								<thead>
									<tr style="color: #31708f; background-color: #d9edf7;border-color: #bce8f1;">
										...
										<th style="border-bottom: none;" class="text-center">Unit Price </th>
