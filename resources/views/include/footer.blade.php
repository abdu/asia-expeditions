              ...
              <div class="row">
                ...
                <ul class="list-unstyled">
                  @foreach(\App\OurNews::where([['post_type','=',1],['web','=',1]])->orderBy('id', 'DESC')->take(4)->get() as $new)
                    <li style="width: 100%; text-align: left;" class="btn w3-padding-small"><i class="fa fa-arrow-circle-right"></i><a style="color: orange; overflow: hidden;" target="_blank" href="/ournews/{{$new->slug}}"> {!! str_limit($new['tour_name'], 42) !!}</a></li>
                  @endforeach                 
