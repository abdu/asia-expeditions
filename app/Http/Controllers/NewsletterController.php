...
class NewsletterController extends Controller
{
    ...
    public function getEmailSubscribe(Request $req)
    {
        if (!EmailSubscriber::checkEmail($req->email)) {
            ...
            return back()->with('submessage', 'Your email has been subsrcribe with us! Thanks you for join with us ');            
        } else {
            return back()->with('submessage', 'Your email already subscribed');
        }
    }
